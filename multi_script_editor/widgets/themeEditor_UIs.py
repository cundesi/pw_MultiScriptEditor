...
# Form implementation generated from reading ui file '/Users/johannes/PycharmProjects/multi_script_editor/multi_script_editor/widgets/themeEditor.ui'
#
...
class Ui_themeEditor(object):
    ...
    def retranslateUi(self, themeEditor):
        themeEditor.setWindowTitle(QtCompat.translate("themeEditor", "Code Theme Editor", None, -1))
        self.label.setText(QtCompat.translate("themeEditor", "Completer text size", None, -1))
        self.save_btn.setText(QtCompat.translate("themeEditor", "Save", None, -1))
        self.del_btn.setText(QtCompat.translate("themeEditor", "Del", None, -1))
        self.apply_btn.setText(QtCompat.translate("themeEditor", "Save", None, -1))
